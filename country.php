...
$countryID = $_GET['id'];
$country = $photos->readACountry($countryID);
$countries = $photos->readCountries();
$result = $photos->readCountryPhotos($countryID);
...
<body>
    ...
    <div class="container py-5">
        ...
        <a href="index.php" class="back text-decoration-none small font-weight-bold text-muted"><i class="fas fa-angle-left"></i> See All</a>
        <h1 class="font-weight-lighter text-center text-lg-left mt-4 mb-0"><?php echo $country['country_name'] ?></h1>
                ...
                <?php foreach ($result as $row) : ?>
                    <div class="col-lg-3 col-md-4 col-6">
                        <a href="destination.php?id=<?php echo $row['photo_id'] ?>" class="d-block mb-4 h-100">
                            <img class="img-hover img-fluid" src="img/<?php echo $row['photo_source'] ?>" alt="<?php echo $row['photo_name'] ?>" style="width: 100%; height:160px; object-fit: cover;">
                        </a>
                    </div>
                <?php endforeach; ?>
            <?php
